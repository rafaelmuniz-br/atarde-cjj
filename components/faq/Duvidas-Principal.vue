<template>
  <Duvidas
    ...
    subtitle="Tudo que você precisa saber está aqui."
    :faqItems="faqItems"
  />
</template>
...
<script setup>
  ...
  const faqItems = [
      ...
      },
      {
        ...
        answer: 'O regulamento está disponível para download na própria página do concurso ou através desse link: <a href="https://www.google.com/" target="_blank" rel="noopener noreferrer"><strong>www.linkenormegigantesco.com.br</strong></a>',
      },
    ];
</script>
